...
(() => {
  var s = {
      333: (s, n, a) => {
        "use strict";
        a.r(n), a.d(n, { agoraStatesDiscussions: () => e });
        const { sanitize: t } = a(856),
          e = [
            {
            ...
            },
            {
              ...
              title:
                "코플릿 배열 18번 인스턴스(주소값 동일)에 대해 알고 싶습니다.",
              ...
              answer: {
                ...
                avatarUrl:
                  "https://avatars.githubusercontent.com/u/71388830?s=64&v=4",
              },
              bodyHTML:
            ...
            },
            {
              ...
              avatarUrl:
                "https://avatars.githubusercontent.com/u/73211553?s=64&v=4",
            },
            {
            ...
            },
            {
              ...
              title:
                "ubuntu에서 github로그인 진행시 npx 명령어 문법 오류가 나옵니다.",
            ...
            },
            {
              ...
              answer: {
                ...
                avatarUrl:
                  "https://avatars.githubusercontent.com/u/98820643?s=64&v=4",
              },
              bodyHTML:
            ...
            },
            {
              ...
              title:
                "계산기 과제에서 SpecRunner로는 통과되는데 npm run test는 안됩니다.",
              ...
              answer: {
                ...
                avatarUrl:
                  "https://avatars.githubusercontent.com/u/56419872?s=64&v=4",
              },
              bodyHTML:
            ...
            },
            {
              ...
              avatarUrl:
                "https://avatars.githubusercontent.com/u/100138593?s=64&v=4",
            },
            {
              id: "D_kwDOHOApLM4APfWM",
              createdAt: "2022-05-09T05:08:49Z",
              title:
                "계산기 과제 제출에서 start와 test가 비정상적으로 작동합니다.",
              ...
              avatarUrl:
                "https://avatars.githubusercontent.com/u/104156381?s=64&v=4",
            },
            {
            ...
            },
            {
              ...
              title:
                "Ubuntu 에서 nvm 버전 확인시 Command 'nvm' not found, did you mean:",
              ...
              avatarUrl:
                "https://avatars.githubusercontent.com/u/104333249?s=64&v=4",
            },
            {
              id: "D_kwDOHOApLM4APfUG",
              createdAt: "2022-05-09T03:02:38Z",
              title:
                'nvm 설치 후 "zsh: command not found: nvm" 오류메세지가 뜹니다',
              ...
              avatarUrl:
                "https://avatars.githubusercontent.com/u/86146661?s=64&v=4",
            },
            {
              ...
              avatarUrl:
                "https://avatars.githubusercontent.com/u/102455275?s=64&v=4",
            },
            {
            ...
            },
            {
              ...
              title:
                "UrClass에서 제공하는 이미지를 블로그에 인용해도 괜찮을까요?",
            ...
            },
            {
              ...
              answer: {
                ...
                avatarUrl:
                  "https://avatars.githubusercontent.com/u/91973744?s=64&v=4",
              },
              bodyHTML:
            ...
            s.answer
              ? {
                  ...s,
                  bodyHTML: t(s.bodyHTML),
                  answer: { ...s.answer, bodyHTML: t(s.answer.bodyHTML) },
                }
              : { ...s, bodyHTML: t(s.bodyHTML) }
          );
      },
      902: (s, n, a) => {
        "use strict";
            ...
            (n.toString = function () {
              return this.map(function (n) {
                var a = "",
                  t = void 0 !== n[5];
                return (
                  n[4] && (a += "@supports (".concat(n[4], ") {")),
                  n[2] && (a += "@media ".concat(n[2], " {")),
                  t &&
                    (a += "@layer".concat(
        ...
        s.exports = (function () {
            ...
            return (
              (t = a()
                ...
                : function (s, a, t) {
                    var e = [null];
                    e.push.apply(e, a);
                    var p = new (Function.bind.apply(s, e))();
                    return t && n(p, t.prototype), p;
                  }),
          ...
          function e(s) {
            return (
              ...
              (function (s, n) {
                if (s) {
                  if ("string" == typeof s) return p(s, n);
          ...
          function p(s, n) {
            (null == n || n > s.length) && (n = s.length);
            for (var a = 0, t = new Array(n); a < n; a++) t[a] = s[a];
            return t;
          }
          ...
          var f,
            k = D(Array.prototype.forEach),
            y = D(Array.prototype.pop),
            v = D(Array.prototype.push),
            j = D(String.prototype.toLowerCase),
            w = D(String.prototype.match),
            E = D(String.prototype.replace),
            A = D(String.prototype.indexOf),
            _ = D(String.prototype.trim),
            x = D(RegExp.prototype.test),
            C =
              ((f = TypeError),
              function () {
                for (
          ...
          function B(s, n) {
            for (; null !== s; ) {
              var a = i(s, n);
              if (a) {
                if (a.get) return D(a.get);
                if ("function" == typeof a.value) return D(a.value);
              }
              s = c(s);
            }
            return function (s) {
          ...
          var O = u([
            ...
            X = function (n, a) {
              if ("object" !== s(n) || "function" != typeof n.createPolicy)
                return null;
              var t = null,
                e = "data-tt-policy-suffix";
              a.currentScript &&
                a.currentScript.hasAttribute(e) &&
                (t = a.currentScript.getAttribute(e));
              var p = "dompurify" + (t ? "#" + t : "");
              try {
                ...
                return (
                  console.warn(
                    "TrustedTypes policy " + p + " could not be created."
                  ),
                  null
                );
              }
          ...
          return (function n() {
            ...
            var p = a.document,
              ...
              d = a.NodeFilter,
              m = a.NamedNodeMap,
              h = void 0 === m ? a.NamedNodeMap || a.MozNamedAttrMap : m,
              g = a.HTMLFormElement,
              b = a.DOMParser,
              f = a.trustedTypes,
              D = i.prototype,
            ...
            if ("function" == typeof l) {
              var ts = o.createElement("template");
              ts.content &&
                ts.content.ownerDocument &&
                (o = ts.content.ownerDocument);
            }
            var es = X(f, p),
              ps = es ? es.createHTML("") : "",
              os = o,
              rs = os.implementation,
              ls = os.createNodeIterator,
              cs = os.createDocumentFragment,
              is = os.getElementsByTagName,
              us = p.importNode,
              ds = {};
            try {
              ds = T(o).documentMode ? o.documentMode : {};
            } catch (s) {}
            var ms = {};
            t.isSupported =
              "function" == typeof as &&
              rs &&
              void 0 !== rs.createHTMLDocument &&
              9 !== ds;
            var hs,
              gs,
              bs = K,
              ...
              ws = J,
              Es = null,
              As = N({}, [].concat(e(O), e(M), e(S), e(U), e(I))),
              _s = null,
              xs = N({}, [].concat(e(q), e(F), e(R), e(P))),
              Cs = Object.seal(
                Object.create(null, {
                  tagNameCheck: {
                    writable: !0,
              ...
              Ws = null,
              Js = N({}, ["audio", "video", "img", "source", "image", "track"]),
              Gs = null,
              Vs = N({}, [
                "alt",
                "class",
              ...
              Xs = "http://www.w3.org/1999/xhtml",
              Qs = Xs,
              sn = !1,
              nn = ["application/xhtml+xml", "text/html"],
              an = "text/html",
              tn = null,
              en = o.createElement("form"),
              pn = function (s) {
                ...
                (tn && tn === n) ||
                  ...
                  (hs = hs =
                    -1 === nn.indexOf(n.PARSER_MEDIA_TYPE)
                      ...
                      : n.PARSER_MEDIA_TYPE),
                  (gs =
                    "application/xhtml+xml" === hs
                      ? function (s) {
                          return s;
                        }
                      : j),
                  (Es = "ALLOWED_TAGS" in n ? N({}, n.ALLOWED_TAGS, gs) : As),
                  (_s = "ALLOWED_ATTR" in n ? N({}, n.ALLOWED_ATTR, gs) : xs),
                  (Gs =
                    "ADD_URI_SAFE_ATTR" in n
                      ? N(T(Vs), n.ADD_URI_SAFE_ATTR, gs)
                      : Vs),
                  (Ws =
                    "ADD_DATA_URI_TAGS" in n
                      ? N(T(Js), n.ADD_DATA_URI_TAGS, gs)
                      : Js),
                  (Zs =
                    "FORBID_CONTENTS" in n ? N({}, n.FORBID_CONTENTS, gs) : zs),
                  (Ds = "FORBID_TAGS" in n ? N({}, n.FORBID_TAGS, gs) : {}),
                  (Ns = "FORBID_ATTR" in n ? N({}, n.FORBID_ATTR, gs) : {}),
                  (Ks = "USE_PROFILES" in n && n.USE_PROFILES),
                  (Ts = !1 !== n.ALLOW_ARIA_ATTR),
                  (Bs = !1 !== n.ALLOW_DATA_ATTR),
                  (Os = n.ALLOW_UNKNOWN_PROTOCOLS || !1),
                  (Ms = n.SAFE_FOR_TEMPLATES || !1),
                  (Ss = n.WHOLE_DOCUMENT || !1),
                  (Hs = n.RETURN_DOM || !1),
                  (Is = n.RETURN_DOM_FRAGMENT || !1),
                  (qs = n.RETURN_TRUSTED_TYPE || !1),
                  (Us = n.FORCE_BODY || !1),
                  (Fs = !1 !== n.SANITIZE_DOM),
                  (Rs = !1 !== n.KEEP_CONTENT),
                  (Ps = n.IN_PLACE || !1),
                  (ws = n.ALLOWED_URI_REGEXP || ws),
                  (Qs = n.NAMESPACE || Xs),
                  n.CUSTOM_ELEMENT_HANDLING &&
                    pn(n.CUSTOM_ELEMENT_HANDLING.tagNameCheck) &&
                    (Cs.tagNameCheck = n.CUSTOM_ELEMENT_HANDLING.tagNameCheck),
                  n.CUSTOM_ELEMENT_HANDLING &&
                    pn(n.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) &&
                    (Cs.attributeNameCheck =
                      n.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),
                  n.CUSTOM_ELEMENT_HANDLING &&
                    "boolean" ==
                      typeof n.CUSTOM_ELEMENT_HANDLING
                        .allowCustomizedBuiltInElements &&
                    (Cs.allowCustomizedBuiltInElements =
                  ...
                  Ks &&
                    ((Es = N({}, e(I))),
                    (_s = []),
                    !0 === Ks.html && (N(Es, O), N(_s, q)),
                    !0 === Ks.svg && (N(Es, M), N(_s, F), N(_s, P)),
                    !0 === Ks.svgFilters && (N(Es, S), N(_s, F), N(_s, P)),
                    !0 === Ks.mathMl && (N(Es, U), N(_s, R), N(_s, P))),
                  n.ADD_TAGS &&
                    (Es === As && (Es = T(Es)), N(Es, n.ADD_TAGS, gs)),
                  n.ADD_ATTR &&
                    (_s === xs && (_s = T(_s)), N(_s, n.ADD_ATTR, gs)),
                  n.ADD_URI_SAFE_ATTR && N(Gs, n.ADD_URI_SAFE_ATTR, gs),
                  n.FORBID_CONTENTS &&
                    (Zs === zs && (Zs = T(Zs)), N(Zs, n.FORBID_CONTENTS, gs)),
                  Rs && (Es["#text"] = !0),
                  Ss && N(Es, ["html", "head", "body"]),
                  Es.table && (N(Es, ["tbody"]), delete Ds.tbody),
                  u && u(n),
                  (tn = n));
              },
              rn = N({}, ["mi", "mo", "mn", "ms", "mtext"]),
              ln = N({}, ["foreignobject", "desc", "title", "annotation-xml"]),
              cn = N({}, ["title", "style", "font", "a", "script"]),
              un = N({}, M);
            N(un, S), N(un, L);
            var dn = N({}, U);
            N(dn, H);
            var mn = function (s) {
                var n = as(s);
                (n && n.tagName) ||
                  (n = { namespaceURI: Xs, tagName: "template" });
                var a = j(s.tagName),
                  t = j(n.tagName);
                return s.namespaceURI === Ys
                  ? n.namespaceURI === Xs
                    ? "svg" === a
                    : n.namespaceURI === $s
                    ? "svg" === a && ("annotation-xml" === t || rn[t])
                    : Boolean(un[a])
                  : s.namespaceURI === $s
                  ? n.namespaceURI === Xs
                    ? "math" === a
                    ...
                    : Boolean(dn[a])
                  : s.namespaceURI === Xs &&
                    !(n.namespaceURI === Ys && !ln[t]) &&
                    !(n.namespaceURI === $s && !rn[t]) &&
                    !dn[a] &&
                    (cn[a] || !un[a]);
              },
              hn = function (s) {
                v(t.removed, { element: s });
                try {
              ...
              gn = function (s, n) {
                try {
                  v(t.removed, { attribute: n.getAttributeNode(s), from: n });
                } catch (s) {
                  v(t.removed, { attribute: null, from: n });
                }
                if ((n.removeAttribute(s), "is" === s && !_s[s]))
                  if (Hs || Is)
                    try {
                      hn(n);
                    } catch (s) {}
              ...
              bn = function (s) {
                ...
                "application/xhtml+xml" === hs &&
                  (s =
                    ...
                    s +
                    "</body></html>");
                var e = es ? es.createHTML(s) : s;
                if (Qs === Xs)
                  try {
                    n = new b().parseFromString(e, hs);
                  } catch (s) {}
                if (!n || !n.documentElement) {
                  n = rs.createDocument(Qs, "template", null);
                  try {
                    n.documentElement.innerHTML = sn ? "" : e;
                  } catch (s) {}
                }
                var p = n.body || n.documentElement;
                return (
                  s &&
                    a &&
                    p.insertBefore(
              ...
              jn = function (s) {
                var n;
                if ((vn("beforeSanitizeElements", s, null), kn(s)))
                  return hn(s), !0;
                if (x(/[\u0080-\uFFFF]/, s.nodeName)) return hn(s), !0;
                var a = gs(s.nodeName);
                if (
                  (vn("uponSanitizeElement", s, {
                    tagName: a,
                    allowedTags: Es,
                  }),
                  s.hasChildNodes() &&
                    !yn(s.firstElementChild) &&
                    (!yn(s.content) || !yn(s.content.firstElementChild)) &&
                    x(/<[/\w]/g, s.innerHTML) &&
                    x(/<[/\w]/g, s.textContent))
                )
                  return hn(s), !0;
                if ("select" === a && x(/<template/i, s.innerHTML))
                  return hn(s), !0;
                if (!Es[a] || Ds[a]) {
                  if (!Ds[a] && En(a)) {
                    if (
                      Cs.tagNameCheck instanceof RegExp &&
                      x(Cs.tagNameCheck, a)
                    )
                      return !1;
                    if (
                      Cs.tagNameCheck instanceof Function &&
                      Cs.tagNameCheck(a)
                    )
                      return !1;
                  }
                  if (Rs && !Zs[a]) {
                    var e = as(s) || s.parentNode,
                      p = ns(s) || s.childNodes;
                    if (p && e)
                      for (var o = p.length - 1; o >= 0; --o)
                        e.insertBefore(Q(p[o], !0), ss(s));
                  }
                  return hn(s), !0;
                }
                return s instanceof i && !mn(s)
                  ? (hn(s), !0)
                  : ("noscript" !== a && "noembed" !== a) ||
                    !x(/<\/no(script|embed)/i, s.innerHTML)
                  ? (Ms &&
                      3 === s.nodeType &&
                      ((n = s.textContent),
                      (n = E(n, bs, " ")),
                      (n = E(n, fs, " ")),
                      s.textContent !== n &&
                        (v(t.removed, { element: s.cloneNode() }),
                        (s.textContent = n))),
                    vn("afterSanitizeElements", s, null),
                    !1)
                  : (hn(s), !0);
              },
              wn = function (s, n, a) {
                if (Fs && ("id" === n || "name" === n) && (a in o || a in en))
                  return !1;
                if (Bs && !Ns[n] && x(ks, n));
                else if (Ts && x(ys, n));
                else if (!_s[n] || Ns[n]) {
                    ...
                    !(
                      (En(s) &&
                        ((Cs.tagNameCheck instanceof RegExp &&
                          ...
                          (Cs.tagNameCheck instanceof Function &&
                            Cs.tagNameCheck(s))) &&
                        ((Cs.attributeNameCheck instanceof RegExp &&
                          x(Cs.attributeNameCheck, n)) ||
                          (Cs.attributeNameCheck instanceof Function &&
                            Cs.attributeNameCheck(n)))) ||
                      ("is" === n &&
                        Cs.allowCustomizedBuiltInElements &&
                        ((Cs.tagNameCheck instanceof RegExp &&
                          x(Cs.tagNameCheck, a)) ||
              ...
              An = function (n) {
                var a, e, p, o;
                vn("beforeSanitizeAttributes", n, null);
                var r = n.attributes;
                if (r) {
                  var l = {
                    attrName: "",
                  ...
                  for (o = r.length; o--; ) {
                    var c = (a = r[o]),
                      ...
                      u = c.namespaceURI;
                    if (
                      ((e = "value" === i ? a.value : _(a.value)),
                      (p = gs(i)),
                      (l.attrName = p),
                      (l.attrValue = e),
                      (l.keepAttr = !0),
                      (l.forceKeepAttr = void 0),
                      vn("uponSanitizeAttribute", n, l),
                      (e = l.attrValue),
                      !l.forceKeepAttr && (gn(i, n), l.keepAttr))
                    )
                      if (x(/\/>/i, e)) gn(i, n);
                      else {
                        Ms && ((e = E(e, bs, " ")), (e = E(e, fs, " ")));
                        var d = gs(n.nodeName);
                        if (wn(d, p, e)) {
                          if (
                            es &&
                            ...
                            if (u);
                              ...
                              switch (f.getAttributeType(d, p)) {
                                case "TrustedHTML":
                                  e = es.createHTML(e);
                                  break;
                                case "TrustedScriptURL":
                                  e = es.createScriptURL(e);
                              }
                          try {
                            u
                              ? n.setAttributeNS(u, i, e)
                              : n.setAttribute(i, e),
                              y(t.removed);
                          } catch (s) {}
                        }
                  ...
                  vn("afterSanitizeAttributes", n, null);
                }
              },
              _n = function s(n) {
                var a,
                  t = fn(n);
                for (
                  vn("beforeSanitizeShadowDOM", n, null);
                  (a = t.nextNode());

                )
                  vn("uponSanitizeShadowNode", a, null),
                    jn(a) || (a.content instanceof r && s(a.content), An(a));
                vn("afterSanitizeShadowDOM", n, null);
              };
            return (
              (t.sanitize = function (n, e) {
                var o, l, i, u, d;
                if (
                  ((sn = !n) && (n = "\x3c!--\x3e"),
                  "string" != typeof n && !yn(n))
                ) {
                ...
                if (!t.isSupported) {
                  if (
                    ...
                    if ("string" == typeof n) return a.toStaticHTML(n);
                    if (yn(n)) return a.toStaticHTML(n.outerHTML);
                  }
                  return n;
                }
                if (
                  ...
                  (1 ===
                    (l = (o = bn("\x3c!----\x3e")).ownerDocument.importNode(
                      n,
                      !0
                    )).nodeType &&
                    "BODY" === l.nodeName) ||
                  ...
                  if (!Hs && !Ms && !Ss && -1 === n.indexOf("<"))
                    return es && qs ? es.createHTML(n) : n;
                  if (!(o = bn(n))) return Hs ? null : qs ? ps : "";
                }
                o && Us && hn(o.firstChild);
                for (var h = fn(Ps ? n : o); (i = h.nextNode()); )
                  (3 === i.nodeType && i === u) ||
                    jn(i) ||
                    (i.content instanceof r && _n(i.content), An(i), (u = i));
                if (((u = null), Ps)) return n;
                if (Hs) {
                  if (Is)
                    for (d = cs.call(o.ownerDocument); o.firstChild; )
                      d.appendChild(o.firstChild);
                  else d = o;
                  return _s.shadowroot && (d = us.call(p, d, !0)), d;
                }
                var g = Ss ? o.outerHTML : o.innerHTML;
                return (
                  Ss &&
                    Es["!doctype"] &&
                    o.ownerDocument &&
                    ...
                    x($, o.ownerDocument.doctype.name) &&
                    (g =
                      "<!DOCTYPE " + o.ownerDocument.doctype.name + ">\n" + g),
                  Ms && ((g = E(g, bs, " ")), (g = E(g, fs, " "))),
                  es && qs ? es.createHTML(g) : g
                );
              }),
              (t.setConfig = function (s) {
                on(s), (Ls = !0);
              }),
              ...
              (t.addHook = function (s, n) {
                "function" == typeof n && ((ms[s] = ms[s] || []), v(ms[s], n));
              }),
              (t.removeHook = function (s) {
                if (ms[s]) return y(ms[s]);
              }),
      ...
      379: (s) => {
        ...
        function t(s, t) {
          for (var p = {}, o = [], r = 0; r < s.length; r++) {
            ...
            if (-1 !== d) n[d].references++, n[d].updater(m);
              ...
              var h = e(m, t);
              (t.byIndex = r),
                n.splice(r, 0, { identifier: u, updater: h, references: 1 });
            }
            o.push(u);
          }
          return o;
        ...
        s.exports = function (s, e) {
          ...
          return function (s) {
            ...
            for (var l = t(s, e), c = 0; c < p.length; c++) {
              var i = a(p[c]);
      ...
      216: (s) => {
        ...
        s.exports = function (s) {
          ...
          return s.setAttributes(n, s.attributes), s.insert(n, s.options), n;
        };
      },
      565: (s, n, a) => {
        "use strict";
        ...
        s.exports = function (s) {
          ...
          return {
            update: function (a) {
              !(function (s, n, a) {
                var t = "";
                a.supports && (t += "@supports (".concat(a.supports, ") {")),
                  a.media && (t += "@media ".concat(a.media, " {"));
                var e = void 0 !== a.layer;
                e &&
                  (t += "@layer".concat(
                ...
                p &&
                  ...
                  n.styleTagTransform(t, s, n.options);
              })(n, s, a);
            },
            remove: function () {
              !(function (s) {
  ...
  function a(t) {
    ...
    var p = (n[t] = { id: t, exports: {} });
    return s[t].call(p.exports, p, p.exports, a), p.exports;
  }
  (a.n = (s) => {
    ...
    (a.d = (s, n) => {
      for (var t in n)
        a.o(n, t) &&
          !a.o(s, t) &&
          Object.defineProperty(s, t, { enumerable: !0, get: n[t] });
    }),
    (a.o = (s, n) => Object.prototype.hasOwnProperty.call(s, n)),
    (a.r = (s) => {
      "undefined" != typeof Symbol &&
        Symbol.toStringTag &&
    ...
    (a.nc = void 0),
    (() => {
      const { agoraStatesDiscussions: s } = a(333);
      let n;
      a(110);
      const t = localStorage.getItem("agoraStatesDiscussions");
      n = t ? JSON.parse(t) : s.slice();
      const e = (s) => {
          const n = document.createElement("li");
          n.className = "discussion__container";
          const a = document.createElement("div");
          a.className = "discussion__avatar--wrapper";
          const t = document.createElement("div");
          t.className = "discussion__content";
          const e = document.createElement("div");
          e.className = "discussion__answered";
          const p = document.createElement("img");
          (p.src = s.avatarUrl), (p.alt = "avatar of " + s.author), a.append(p);
          const o = document.createElement("h2"),
            r = document.createElement("a");
          (r.href = s.url), (r.textContent = s.title), o.append(r);
          const l = document.createElement("div");
          (l.className = "discussion__information"),
            (l.textContent = `${s.author} / ${new Date(
              s.createdAt
            ).toLocaleTimeString()}`),
            t.append(o, l);
          const c = document.createElement("p");
          return (
            (c.textContent = s.answer ? "☑" : "☒"),
            e.append(c),
            n.append(a, t, e),
            n
          );
        ...
        p = (s, a, t) => {
          for (
            console.log(a, t), a || t || ((a = 0), (t = n.length - 1));
            s.firstChild;

          )
            s.removeChild(s.firstChild);
          for (let p = a; p < t; p += 1) s.append(e(n[p]));
        };
      let o = 10,
        r = 1;
      const l = document.querySelector("ul.discussions__container");
      p(l, 0, o);
      const c = (s, a) => {
          const t = n.length - 1;
          let e = Number(a - 1) * Number(s),
            p = Number(e) + Number(s);
          return (
            a <= 0 && (e = 0), p >= t && (p = t), { pageStart: e, pageEnd: p }
          );
        },
        i = document.querySelector(".buttons");
      i.children[0].addEventListener("click", () => {
        r > 1 && (r -= 1);
        const { pageStart: s, pageEnd: n } = c(o, r);
        p(l, s, n);
      }),
        i.children[1].addEventListener("click", () => {
          o * r < n.length - 1 && (r += 1);
          const { pageStart: s, pageEnd: a } = c(o, r);
          p(l, s, a);
        }),
      ...
      const u = document.querySelector("form.form"),
        d = u.querySelector("div.form__input--name > input"),
        m = u.querySelector("div.form__input--title > input"),
        h = u.querySelector("div.form__textbox > textarea");
      u.addEventListener("submit", (s) => {
        s.preventDefault();
        const a = {
          id: "unique id",
        ...
        n.unshift(a),
          localStorage.setItem("agoraStatesDiscussions", JSON.stringify(n)),
          p(l, 0, o);
      });
    })();
})();
